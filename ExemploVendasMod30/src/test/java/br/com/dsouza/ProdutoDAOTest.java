...
import br.com.dsouza.dao.ProdutoDAO;
...
public class ProdutoDAOTest {
	...
	public void pesquisar() throws MaisDeUmRegistroException, TableException, DAOException, TipoChaveNaoEncontradaException {
		...
		// TESTA NOVO CAMPO
		Assert.assertEquals(Integer.valueOf(10), produtoDB.getQuantidade());
	...
	public void salvar() throws TipoChaveNaoEncontradaException, DAOException {
		...
		// TESTA NOVO CAMPO
		Assert.assertEquals(Integer.valueOf(10), produto.getQuantidade());
	...
	public void alterarCliente() throws TipoChaveNaoEncontradaException, DAOException, MaisDeUmRegistroException, TableException {
		...
		// TESTA ALTERAÇÃO DO NOVO CAMPO
		Assert.assertEquals(Integer.valueOf(20), produtoBD.getQuantidade());
	...
	public void buscarTodos() throws DAOException, TipoChaveNaoEncontradaException {
		...
		for (Produto prod : list) {
			...
			// TESTA NOVO CAMPO
			Assert.assertNotNull(prod.getQuantidade());
